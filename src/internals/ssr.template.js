module.exports = ({ customFields, favicon, baseUrl, organizationName, url }) => `
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    ...
    <link rel="icon" href="${url}${baseUrl}favicon.png" />
    <link rel="icon" href="${url}${baseUrl}favicon.svg" type="image/svg+xml" />
    <link rel="apple-touch-icon" href="${url}${baseUrl}img/icons/apple-180x180.png" sizes="180x180" />
