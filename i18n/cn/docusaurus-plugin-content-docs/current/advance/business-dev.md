...
而不是完全从0开始，如果你从[快速入门](../quick-start/quick-start)章节过来，这份源码结构对你来说不是问题。

点击[这里下载](../resource/book.zip)演示工程基础源码
...
注意：user中的sql语句请自行创建到db中去，更多准备工作见[准备工作](../prepare/prepare)
